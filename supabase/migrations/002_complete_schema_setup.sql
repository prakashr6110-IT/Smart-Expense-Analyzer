-- Smart Expense Behavior Analyzer - Complete Database Setup
...
-- Insert some sample data for testing (optional - delete if you want to start fresh)
-- This will only run if you have existing users
INSERT INTO public.expenses (user_id, amount, category, expense_date, expense_time, description)
SELECT 
  id,
  500.00,
  'Food',
  CURRENT_DATE,
  '12:30:00',
  'Sample expense - Lunch'
FROM public.profiles
WHERE NOT EXISTS (
  SELECT 1 FROM public.expenses WHERE user_id = public.profiles.id
)
LIMIT 1;
